...
--
-- Host: localhost:8889
-- Gegenereerd op: 28 jan 2019 om 17:57
-- Serverversie: 5.7.23
-- PHP-versie: 7.2.10
...
(3, 'Cie Xav To Yilo', 'Silento', 'Dit dansduo, begeleid door een muzikant, ontdekt de sensuele liefde op de grond en aan het luchtkader. De choreografie mengt het horizontale met het verticale. (30 min.)', 'assets/img/silento.png', 'Locatie 1: KA / BS De Bever', 'assets/img/loc1', 'voorstelling', 'Vr 24.08', '19:30 en 22:00'),
...
(19, 'Gekke fietsen circuit', 'Gekke fietsen circuit', 'Scouts en Chiro Sint-Martinus On Wheels zetten drie dagen lang het centrum op stelten met knotsgek fiets plezier en diertjes op wielen. Lol trappen krijgt plots een andere betekenis.', 'assets/img/gekkefietsencircuit.png', 'Locatie 1: Donkvijverstraat', '', 'activiteit', 'Vr 24.08', 'Doorlopend'),
...
(48, 'Ballonnen piraat', 'Ballonnen piraat', 'De Ballonnenpiraat uit Beveren tovert in enkele minuten de tofste figuurtjes uit zijn mouw. Zeg nu zelf welk kind is er niet blij met een reuze octopus, een mooie kat of een coole auto, … .', 'assets/img/ballonnenpiraat.png', 'mobiel', '', 'straatact', 'Zo 26.08', 'Doorlopend'),
...
(53, 'Chiro Sint-Martinus', 'Reuzebbq', 'Wie voor het muzikale zomerfeest van start gaat de dansbenen nog even van de nodige energie wil voorzien, kan zich vanaf 17 uur culinair laten verwennen op de reuzebarbecue van de chiromeisjes Sint-Martinus en chirojongens Beveren.\r\n\r\nVooraf inschrijven is noodzakelijk en kan tot 18 augustus via bbqchirobeveren@hotmail.com of 0476 86 12 77 of bij iemand van de leiding.', 'assets/img/bbq.png', 'Locatie 8: Grote Markt', '', 'activiteit', 'Vr 24.08', '17:00');
